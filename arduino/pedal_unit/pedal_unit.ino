...
KeyHammer keys[] = { { []() -> int { return analogRead(28); }, 36, 'p', 1010, 0, 0.2, 8500},
                    { []() -> int { return analogRead(27); }, 36, 'p', 1010, 0, 0.2, 8500},
                    { []() -> int { return analogRead(26); }, 36, 'p', 1010, 0, 0.2, 8500},
                  };
                  };
